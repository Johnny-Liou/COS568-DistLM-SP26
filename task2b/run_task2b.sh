...
#   node3 (10.10.1.1): bash run_task2b.sh 0   ← master / rank 0
#   node0 (10.10.1.2): bash run_task2b.sh 1
#   node1 (10.10.1.x): bash run_task2b.sh 2
#   node2 (10.10.1.x): bash run_task2b.sh 3
