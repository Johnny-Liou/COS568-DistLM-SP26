# coding=utf-8
# Task 4 (based on Task 2b): Profiling all_reduce gradient synchronization
...
def train(args, train_dataset, model, tokenizer):
    ...
    logger.info("***** Running training (Task 4 / 2b: all_reduce + profiling) *****")
    ...
    trace_dir = os.path.join(args.output_dir, f"trace_2b_rank{args.local_rank}")
    ...
    with torch.profiler.profile(
        ...
        for step, batch in enumerate(epoch_iterator):
            ...
            # Gradient synchronization via all_reduce happens BEFORE clipping
            # to ensure we clip the global average gradient, matching DDP behavior.
