#!/bin/bash
# Task 2(a): Gradient synchronization with gather/scatter
# Master node is node3 (IP: 10.10.1.1), which runs with --local_rank 0
# Run this script on EACH node with the correct --local_rank:
#   node3 (10.10.1.1): bash run_task2a.sh 0   ← master / rank 0
#   node0 (10.10.1.2): bash run_task2a.sh 1
#   node1 (10.10.1.x): bash run_task2a.sh 2
#   node2 (10.10.1.x): bash run_task2a.sh 3
